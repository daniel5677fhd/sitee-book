  ...
  <div class="container-lg px-3 my-5 markdown-body">
    ...
    <div class="container-lg px-3 my-5 markdown-body">
      ...
      <div class="container-lg px-3 my-5 markdown-body">
        ...
        <p class="subtitle">
          Clique nos botões abaixo para interagir com os produtos e deixar seu
          comentário!
        </p>
        <a
          class="btn"
          href="https://dashboard.kiwify.com/products"
          target="_blank"
          >Ver Produtos</a
        >
        <a
          class="btn"
          href="https://app.cakto.com.br/dashboard/products?tab=products"
          target="_blank"
          >Ver Produtos</a
        >
        ...
        <div id="comentario-form" style="display: none">
          <h2 id="deixe-seu-comentário">
            Deixe seu comentário:
            <a
              class="anchorjs-link "
              href="#deixe-seu-comentário"
              aria-label="Anchor"
              data-anchorjs-icon=""
        ...
        <button class="btn" id="btnVerComentarios" style="display: inline-block">
          Ver Comentários
        </button>
        ...
        <a
          id="instagram-link"
          href="https://www.instagram.com/motivacao_com_daniel/?hl=en"
          target="_blank"
          title="Instagram Danioficial704"
        ...
        <a
          id="tiktok-link"
          href="https://www.tiktok.com/@jovem.investidor516?_t=ZM-8xb6XYcHwog&amp;_r=1"
          target="_blank"
          title="TikTok Jovem Investidor"
          aria-label="TikTok"
        >
          <svg
            viewBox="0 0 24 24"
        ...
        <script>
          ...
          btnCancelar.addEventListener('click', () => {
            ...
            btnVerComentarios.style.display =
